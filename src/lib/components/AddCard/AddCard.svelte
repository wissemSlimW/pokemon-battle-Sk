...
<div
	class="card rounded-5 add-card p-3 bg-white"
	role="button"
	tabindex="0"
...
>
	<div
		class="w-100 h-100 d-flex rounded-5 justify-content-center text-light align-items-center border border-5 border-light"
	>
		<svg
